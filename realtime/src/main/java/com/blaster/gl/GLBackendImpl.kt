...
class GLBackendImpl : GLBackend {
    ...
    override fun glGenFramebuffers(n: Int, framebuffers: IntArray, offset: Int) = GLES30.glGenFramebuffers(n, framebuffers, offset)
    override fun glBindFramebuffer(target: Int, framebuffer: Int) = GLES30.glBindFramebuffer(target, framebuffer)
    ...
    override fun glDrawBuffers(n: Int, bufs: IntArray, offset: Int) = GLES30.glDrawBuffers(n, bufs, offset)
    ...
    override fun glDrawElements(mode: Int, count: Int, type: Int, offset: Int) = GLES30.glDrawElements(mode, count, type, offset)
    ...
    override fun glGetShaderiv(shader: Int, pname: Int, params: IntArray, offset: Int) = GLES30.glGetShaderiv(shader, pname, params, offset)
    ...
    override fun glGetUniformLocation(program: Int, name: String): Int = GLES30.glGetUniformLocation(program, name)
    ...
    override fun glUniform3fv(location: Int, count: Int, v: FloatArray, offset: Int) = GLES30.glUniform3fv(location, count, v, offset)
    override fun glUniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: FloatBuffer) = GLES30.glUniformMatrix4fv(location, count, transpose, value)
    ...
    override fun glGenRenderbuffers(n: Int, renderbuffers: IntArray, offset: Int) = GLES30.glGenRenderbuffers(n, renderbuffers, offset)
    override fun glBindRenderbuffer(target: Int, renderbuffer: Int) = GLES30.glBindRenderbuffer(target, renderbuffer)
    override fun glRenderbufferStorage(target: Int, internalformat: Int, width: Int, height: Int) = GLES30.glRenderbufferStorage(target, internalformat, width, height)
    ...
    override fun glGenTextures(n: Int, textures: IntArray, offset: Int) = GLES30.glGenTextures(n, textures, offset)
